...
HD_PWD='C:/Users/PugWomp/Documents/Github/VerilogSnake/Verilog_Snake/Verilog_Snake.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log snake_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source snake_top.tcl -notrace
