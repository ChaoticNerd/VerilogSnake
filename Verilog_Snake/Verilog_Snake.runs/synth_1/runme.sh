...
HD_PWD='C:/Users/PugWomp/Documents/Github/VerilogSnake/Verilog_Snake/Verilog_Snake.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log snake_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source snake_top.tcl
